...
3. Update the RPC URL and Chain ID for Mumbai:
```dart
// Blockchain Configuration (Mumbai Testnet)
static const String polygonRpcUrl = 'https://rpc-mumbai.maticvigil.com'; // Or your custom RPC
static const String polygonChainId = '80001'; // Mumbai testnet chain ID
static const String polygonExplorerUrl = 'https://mumbai.polygonscan.com';
```
