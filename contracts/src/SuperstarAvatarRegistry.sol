...
contract SuperstarAvatarRegistry is Ownable, ReentrancyGuard {
    ...
    function createAchievement(
        ...
        _achievementIds++;
        string memory achievementId = string(abi.encodePacked("achievement-", _achievementIds));
    ...
    function createBadge(
        ...
        _badgeIds++;
        string memory badgeId = string(abi.encodePacked("badge-", _badgeIds));
